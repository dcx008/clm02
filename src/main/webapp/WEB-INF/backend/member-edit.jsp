...
<article class="page-container">
    <form action="/member-update" method="post" class="form form-horizontal" id="form-member-add" target="_parent">
        <td>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="@" name="level" id="level" value="${user.level}">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">所在城市：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="userInfo.address">
                    <option value="" selected>请选择城市</option>
                    <option value="北京" <c:if test="${user.userInfo.address=='北京'}">selected="selected"</c:if> >北京</option>
                    <option value="上海" <c:if test="${user.userInfo.address=='上海'}">selected="selected"</c:if> >上海</option>
                    <option value="广州" <c:if test="${user.userInfo.address=='广州'}">selected="selected"</c:if> >广州</option>
                </select>
				</span> </div>
        </div>
