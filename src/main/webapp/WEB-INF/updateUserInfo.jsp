...
<div id="templatemo_main">
    ...
    <div id="content" class="right">
		...
		<h3>收获详细信息</h3>
        <form action="/updateUserNewReceiveInfo">
            <div class="content_half left form_field" style="color:white">
                <input type="hidden" name="receiveInfoId" value="${receiveInfo.receiveInfoId}"/>
                收货人：
                <input name="receiver" type="text" id="receiver" maxlength="40" value="${receiveInfo.receiver}"/>				<br/>
                收货地址:
                <input name="receiveAddress" type="text" id="receive_address" maxlength="40" value="${receiveInfo.receiveAddress}"/>				<br/>
                收货时间:
                <input name="receiveTime" type="date" id="receive_time" maxlength="40" value="${receiveInfo.receiveTime}"/>
            </div>

            <div class="content_half right form_field" style="color:white">
                邮编:
                <input name="postCode" type="text" id="postcode" maxlength="40" value="${receiveInfo.postCode}"/>
                电话:
                <input name="receiveTelephone" type="text" id="receive_telepho" maxlength="40" value="${receiveInfo.receiveTelephone}"/>
            ...
            <script type="text/javascript">
                ...
                map.addEventListener("click",function(e){
                    ...
                    geoc.getLocation(pt, function(rs){
                        ...
                        document.getElementById("aa").innerHTML = "经度坐标："+e.point.lng+" &nbsp;纬度坐标："+e.point.lat+"你点击的地址是:"+addComp.province  + addComp.city + addComp.district + addComp.street  + addComp.streetNumber;
                    });
